...
# -*- coding: utf-8 -*-
"""
Created on Fri May  9 19:20:43 2025
...
#fig, axs = plt.subplots(1, 2, figsize=(10, 5))  # Aquí cambiamos el nombre de 'ax' y 'ax6' a 'ax5' y 'axs[0,1]'

fig = plt.figure(figsize=(10, 5))  # Más ancho que alto
...
for i, txt in enumerate(df_tm_info_1['Tm']):
    ...
    y = df_tm_info_1['Tm'][i]
    ax6.text(x + 0.03, y + 0.39, f'{txt:.1f}', fontsize=9, ha='center', va='bottom')
"""
