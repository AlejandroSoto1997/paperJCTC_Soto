...
cbar_ax = fig.add_axes([0.92, 0.2, 0.025, 0.6])  # [left, bottom, width, height]
...
axins = ax3.inset_axes([0.55, 0.1, 0.2, 0.2])  # (x0, y0, width, height) del panel secundario
...
ax3.set_ylim(0, 1)
ax3.set_xlim(-160, 120)
ax3.set_yticks(np.arange(0, 1.2, 0.2))
ax3.set_xticks(np.arange(10, 110, 20))
...
plt.tight_layout()
plt.savefig('figure_v2_2.png', dpi=400)
plt.show()
